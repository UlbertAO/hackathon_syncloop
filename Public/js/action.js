...
function updateTitleCB() {
  ...
  if (PlaylistIdVal) {
    ...
    window.location = "https://accounts.google.com/o/oauth2/v2/auth?scope=https://www.googleapis.com/auth/youtube&state=state_parameter_passthrough_value&redirect_uri=https://hackathonsyncloop.ulbertao.repl.co&response_type=token&client_id=644444506873-u1f31kni740e6575ek5ofa55opmvtj8i.apps.googleusercontent.com"
  } else {
